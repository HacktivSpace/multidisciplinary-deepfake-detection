...
def evaluate_vision_transformer(model, dataloader, device):
    ...
    try:
        ...
        report_path = 'path/to/report_dir/vision_transformer_classification_report.json'
        cm_path = 'path/to/report_dir/vision_transformer_confusion_matrix.csv'
        accuracy_path = 'path/to/report_dir/vision_transformer_accuracy.txt'
