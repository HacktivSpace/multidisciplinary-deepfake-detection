...
def evaluate_svm(model, X_test, y_test):
    ...
    try:
        ...
        report_path = 'path/to/report_dir/svm_classification_report.json'
        cm_path = 'path/to/report_dir/svm_confusion_matrix.csv'
        accuracy_path = 'path/to/report_dir/svm_accuracy.txt'
